...
export default function OurGymCard({ title, items }: OurGymCardProps) {
    ...
    return (
        <div className="text-white p-5 mx-2 my-5 rounded-lg border border-yellow-400 shadow shadow-yellow-400 bg-gray-900/20">
                    ...
                    {items.map(function (item, index) {
                        return (
                            <li key={index} className="text-white text-center md:text-left">
                                ...
                                <span className="font-light block">{item.value}</span>
                            </li>
                        );
                    })}
                </ul>
